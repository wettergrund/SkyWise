...
namespace API.Migrations
{
    ...
    [Migration("20240508082042_NullableVV")]
    partial class NullableVV
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.DB.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.DB.UserAirportFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserAirportFavorite");
                });

            modelBuilder.Entity("API.Models.DB.UserAirportHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.DB.UserAirportFavorite", b =>
                {
                    b.HasOne("API.Models.DB.User", "User")
                        .WithMany("Favorites")
